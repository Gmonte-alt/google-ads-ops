...
# Note: V000-000-002 will build on the previous version to now include a 3rd query to grab spend, clicks & impression data
#       
...
if clicks_impressions_spend_data is not None:
    # Save clicks, impressions, and spend data to CSV
    save_to_excel(clicks_impressions_spend_data, 'reports/output/clicks_impressions_spend_data.xlsx')
    print("Data successfully saved to 'clicks_impressions_spend_data.xlsx'")
else:
