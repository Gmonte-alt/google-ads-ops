...
# File version: V000-000-002
# Note: Imports the results into a csv, unfiltered
# insert into prompt: python c:\MyPrograms\workstation\GoogleAdsSearchReportsHrly\keywordplanner\ggl_keyword_volumeV000-000-002.py -c 5428037747 
...
if __name__ == "__main__":
    ...
    try:
        main(
            ...
            args.keyword_texts,
            args.page_url,
            output_file = 'keywordplanner/output/nvda_kwplanner_tickers.csv',  # Output CSV file
        )
