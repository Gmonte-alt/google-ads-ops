...
# Notes: Creates the first combination chart in a new worksheet "WTD_CHART" in the final excel workbook output
...
# Run the macro from the final workbook
try:
    excel_app.Application.Run(f"{final_workbook.Name}!Module1.CreateCombinationChart")
