...
# Define a query to select data from the ga4_landingpage_session_data table
query = """
SELECT
    Date,
    Source,
...
csv_file_path = "ga4-reports/output/ga4_sessions_lp_aggregated.csv"
