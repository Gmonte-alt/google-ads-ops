...
# version: V000-000-012
# execution method: python googleads_daily_report_last52weeks.py
# Note: Builds on V000-000-012 to now loop through snapshots of the last 90 days
#       modifies 'calculate_sumary_metrics' to use a 'safe_replace' function for prior months start and end dates
