...
# File name: keywordplanner/ggl_multiple-keyword_volume.py
# File version: V000-000-000
# Note: Builds on ggl_keyword_volumeV000-000-002.py
# insert into prompt: python c:\MyPrograms\workstation\GoogleAdsSearchReportsHrly\keywordplanner\ggl_multiple-keyword_volume.py -c 5428037747 
...
if __name__ == "__main__":
    ...
    try:
        main(
            ...
            args.keyword_texts,
            args.page_url,
            output_file = f'keywordplanner/output/{args.keyword_texts}_kwplanner_tickers.csv',  # Output CSV file
        )
