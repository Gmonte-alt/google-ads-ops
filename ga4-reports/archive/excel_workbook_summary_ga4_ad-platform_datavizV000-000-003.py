...
# Notes: Now incorporates Leads into the vba module 1, and produces outputs for multiple case grouping
...
try:
    ...
    new_module.Name = "DynamicChartModule"
...
# Define the metrics and their top positions for chart placement
...
# Loop through the metrics and chart numbers for each case
try:
