...
# output:
# Notes: Checks if the table exists and the if the last date = end_date. Then the script either creates or updates the table
...
if table_exists:
    # Check the last date of data in the table
    cursor.execute("""
