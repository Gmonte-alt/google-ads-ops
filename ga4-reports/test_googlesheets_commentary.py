...
print("Row values from Google Sheets:", row_values)
...
# Write the data from Google Sheets into the Excel file starting at the specified row and column
for col_num, value in enumerate(row_values, start=start_column):
    worksheet.cell(row=start_row, column=col_num, value=value)
