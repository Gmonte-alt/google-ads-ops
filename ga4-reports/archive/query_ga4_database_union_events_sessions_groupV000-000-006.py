...
# output:
# Notes: Resolved the campaign & channel grouping via the previous python script. Removing groupings in this version
...
total_groups = [
    ('Non-Paid Total', lambda df: df[~df['Channel_Group'].str.contains('SEM|Paid Social + Display')]),
    ('Paid Total', lambda df: df[df['Channel_Group'].str.contains('SEM|Paid Social + Display')]),
    ('SEM Brand Total', lambda df: df[df['Channel_Group'] == 'SEM Brand']),
    ('SEM Non Brand Total', lambda df: df[df['Channel_Group'].str.contains('SEM NonBrand')]),
...
order_df = pd.DataFrame({
    'Channel_Group': ['SEM Brand', 'SEM Brand', 'SEM Non-Brand', 'SEM Non-Brand', 'SEM Non-Brand', 'SEM Non-Brand', 
    ...
    'Campaign_Group': ['Google Search - Brand', 'Google Search - Brand Broad', 'Google Search - Housing', 
                       ...
                       'Facebook Display Prospecting - Traveler', 'Google Display Prospecting', 'Google Display Retargeting', 
