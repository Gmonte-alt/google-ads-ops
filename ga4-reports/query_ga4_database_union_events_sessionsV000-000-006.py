...
# output: table; csv
# Notes: Now includes Facebook Ads data from SuperMetrics API
...
FROM
    facebook_ads_data
"""
df_facebook_ads = pd.read_sql_query(query_facebook_ads, conn_supermetrics)
