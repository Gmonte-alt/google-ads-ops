...
# Note: This version builds on file name ref above and V000-000-003: deletes and back-fills data for recent dates
...
delete_end_date = datetime.now() - timedelta(days=0)
