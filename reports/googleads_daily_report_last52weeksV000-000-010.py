...
# Note: Builds on V000-000-009 to now include device break-out for brand & non-brand
#       
...
if clicks_impressions_spend_data is not None:
    ...
    non_brand_summary = calculate_summary_metrics(non_brand_campaigns)
    ...
    brand_desktop_summary = calculate_summary_metrics(brand_desktop)
    brand_mobile_summary = calculate_summary_metrics(brand_mobile)
    ...
    non_brand_desktop_summary = calculate_summary_metrics(non_brand_desktop)
    non_brand_mobile_summary = calculate_summary_metrics(non_brand_mobile)
