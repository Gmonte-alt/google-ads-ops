...
# output:
# Note: This version builds on V000-000-001 and incorporates a manual_adustments factor, if there are large budget changes across channel groups
...
for group in channel_groups:
    ...
    if group in manual_adjustments:
        ...
        # Apply the manual adjustment factor only if it's different from the default growth rate
        if adjustment_factor != ratio_spend:
