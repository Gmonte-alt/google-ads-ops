...
Sub CreateFilterInformation()
    ...
    ' Use VLOOKUP to reference the visible slicer values in the first pivot table dynamically (R1C1 notation)
    For i = LBound(slicerNames) To UBound(slicerNames)
        ws.Cells(filteredValuesRowStart, slicerStartCol + i).FormulaR1C1 = _
        "=VLOOKUP(R" & filterRowStart & "C" & slicerStartCol + i & "," & lookupRange & ",2,FALSE)"
    Next i
