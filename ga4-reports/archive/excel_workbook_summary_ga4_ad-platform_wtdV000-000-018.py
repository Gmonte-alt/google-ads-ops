...
# Notes: Added more Total rows, including Display Total to be bolded and changed weekly commentary row start to 51
...
def insert_commentary(worksheet_name):
    ...
    start_row = 51 #changed from 46 Sep 9, 2024, to compensate for the "Grand Total" row
