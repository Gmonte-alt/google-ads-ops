...
#       First working version. I need to clean the Test_name to remove double spaces; this script updates that feature  
...
def create_summary_workbook(input_file, output_file):
    ...
    for test_name in df['test_name'].unique():
        ...
        for device in ['mobile', 'desktop']:
            device_df = test_df[test_df['device'] == device]
        ...
        for campaign_name in test_df['campaign_base_campaign_name'].unique():
            ...
            for device in ['mobile', 'desktop']:
                device_campaign_df = campaign_df[campaign_df['device'] == device]
