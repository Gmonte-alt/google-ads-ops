...
# output:
# Notes: Update Total Rows: Paid Social Total, Display total, Google SEM Landlord Total, Google SEM Tenant Total
...
order_df = pd.DataFrame({
    'Channel_Group': [
     ...
     #   'SEM Non-Brand',  # Added "SEM Non-Brand"
        'Paid Total', 'SEM Brand Total', 'SEM Non-Brand Total', 'Google SEM Total', 'Google SEM Landlord Total', 'Google SEM Tenant Total', 
