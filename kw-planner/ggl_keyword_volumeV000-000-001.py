...
# Note: filters the results to the exact keyword_texts_ match
...
def main(
    ...
    for idea in keyword_ideas:
        if idea.text in exact_match_keywords:
            ...
            # Remove the matched keyword from the set to avoid printing duplicates
            exact_match_keywords.remove(idea.text)

    # Print a message for any keywords in keyword_texts that were not found
    for missing_keyword in exact_match_keywords:
        print(f'Keyword "{missing_keyword}" not found in keyword ideas.\n')
