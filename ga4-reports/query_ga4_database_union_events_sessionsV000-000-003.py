...
# output: table; csv
# Notes: Maps the Channel Group to the "ga4_channel_groups_cleaned" and applies a "Campaign Group" logic
...
def assign_campaign_group(row):
    ...
    if channel_group == 'SEM Brand':
        ...
        if source == 'google':
            ...
            return 'Google Search - TNH Non-Brand (All Campaigns)'
        elif source == 'bing':
...
# Function to handle remaining SEM Non-Brand and Paid Social + Display Undefined/Other cases
