...
#       This version uses the newly created "service_account_key_file"
...
def get_hourly_report(client):
    ...
    data = [['Hour', 'Impressions', 'Clicks', 'Cost', 'Conversions']]
    for row in response:
        ...
        data.append([hour, impressions, clicks, cost, conversions])
