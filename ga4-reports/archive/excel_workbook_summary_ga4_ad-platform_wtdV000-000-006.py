...
# output:
# Notes: Adds Title and sub-title line on rows 1 and 2, adds Current ISO and Last Week ISO on rows 3 and 4, adjusted empty row and adds fill color to top rows
