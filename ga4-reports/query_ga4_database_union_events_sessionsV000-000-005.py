...
# output: table; csv
# Notes: Now includes Microsoft Advertising data from SuperMetrics
...
FROM
    bing_ads_data
"""
df_bing_ads = pd.read_sql_query(query_bing_ads, conn_supermetrics)
...
# Union the Google Ads and Bing Ads data with the GA4 combined data
df_final_combined = pd.concat([df_combined, df_google_ads_agg, df_bing_ads])
