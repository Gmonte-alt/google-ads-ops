...
# output:
# Notes: Updates the WTD file to now include "Period" column to filter for WTD or full week
...
def calculate_adjusted_wtd_data(df, reference_date, period_name):
    ...
    # Step 4: Remove unnecessary columns before aggregation
    columns_to_keep = [
    ...
    # Step 5: Group the data by ISO Year, ISO Week, Channel Group, and Campaign Group
