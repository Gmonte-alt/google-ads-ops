...
#       Add the tenant metrics to "metrics" list and define the ROAS calculation
...
def create_summary_workbook(input_file, output_file):
    ...
    metrics = ['impressions', 'clicks', 'cost', 'furnished finder - ga4 (web) ff lead', 'furnished finder - ga4 (web) ff purchase', 'furnished finder - ga4 (web) ff-brsubmit', 'furnished finder - ga4 (web) ff-dmsubmit', 'furnished finder - ga4 (web) ff-phoneget', 'combined_tenant_metrics']
    ...
    def calculate_summary(df):
        ...
        summary['roas'] = ((summary['furnished finder - ga4 (web) ff purchase'] * 170 ) + (summary['furnished finder - ga4 (web) ff-brsubmit'] * 25) + (summary['furnished finder - ga4 (web) ff-dmsubmit'] * 8.75) + (summary['furnished finder - ga4 (web) ff-phoneget'] * 3.75)) / summary['cost']
